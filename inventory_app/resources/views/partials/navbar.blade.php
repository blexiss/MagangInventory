        ...
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="relative ml-auto max-w-xs min-w-[100px] sm:min-w-[150px]">
                ...
                <input type="text" id="search_bar"
                    class="block w-full rounded-lg border border-gray-300 bg-transparent px-10 pt-2 pb-2 text-sm text-gray-900 appearance-none dark:border-gray-600 dark:bg-gray-900 dark:text-white focus:border-blue-600 focus:outline-none focus:ring-0 peer"
                    placeholder=" " />
